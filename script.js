        ...
        ">
          ...
          <div style="display:flex; gap:8px; margin-top:6px; align-items:center;">
            <input id="new-img" type="text" placeholder="https://exemple.com/image.jpg"
              style="flex:1; padding: 9px 12px; border: 1px solid #ddd;
                     border-radius: 6px; font-size: 0.85rem; box-sizing: border-box;">
            <label for="new-img-file" style="
              cursor:pointer; background:#b5a642; color:#fff;
              padding: 9px 13px; border-radius:6px; font-size:1rem;
              white-space:nowrap; user-select:none;
            " title="Choisir depuis PC">📁</label>
            <input type="file" id="new-img-file" accept="image/*" style="display:none">
          </div>
          <div id="new-img-preview" style="display:none; margin-top:8px;">
            <img id="new-img-thumb" style="max-width:100%; max-height:110px; border-radius:8px; border:1px solid #ddd;">
            <button onclick="document.getElementById('new-img-preview').style.display='none'; window._newImgBase64=null; document.getElementById('new-img-file').value=''" 
              style="display:block; margin-top:4px; font-size:.8rem; color:red; background:none; border:none; cursor:pointer;">✕ Supprimer</button>
          </div>
        </label>
